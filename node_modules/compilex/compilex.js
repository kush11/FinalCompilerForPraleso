...
exports.compileCPPWithTestCase = function (envData, code, userName, language, moduleId, fn) {
	if (exports.stats)
		cppModule.stats = true;
	cppModule.compileCPPWithTestCase(envData, code, userName, language, moduleId, fn);
}

exports.compileJavaWithTestCase = function (envData, code, userName, language, moduleId, fn) {
	if (exports.stats)
		javaModule.stats = true;
	javaModule.compileJavaWithTestCase(envData, code, userName, language, moduleId, fn);
}

exports.compilePythonWithTestCase = function (envData, code, userName, language, moduleId, fn) {
	if (exports.stats)
		pyModule.stats = true;
	pyModule.compilePythonWithTestCase(envData, code, userName, language, moduleId, fn);
}
...
exports.compileCsharpWithTestCase = function (envData, code, userName, language, moduleId, fn) {
	if (exports.stats)
		csModule.stats = true;
	csModule.compileCsharpWithTestCase(envData, code, userName, language, moduleId, fn);
}
